      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              "The Scaffold widget serves as a container for the primary visual components of a screen, "
              "providing them with a consistent layout structure and handling common tasks like handling"
              " app bar titles, managing the app bar actions, and defining the overall layout of the screen.",
              style: TextStyle(
                fontSize: 16,
              ),
            ),
            ...
            Text(
              "How to build a Scaffold Widget in Flutter?",
